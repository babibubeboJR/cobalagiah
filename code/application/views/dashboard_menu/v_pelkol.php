				...
				<div class="portlet-body">
					<div class="table-toolbar">
						<div class="row">
							...
							<div class="col-md-3">
								<select class="form-control" name="datafilter" id="select_status">
							...
							<div class="col-md-3">
								<input id="type_rayon" value="pelanggan_KOLEKTIF" hidden>
								<select class="form-control" name="datafilter" id="select_rayon">
									<option selected value="">--Nama Rayon--</option>
									<option value="RYN LAWANG">RYN LAWANG</option>
									<option value="RYN BULULAWANG">RYN BULULAWANG</option>
									<option value="RYN BATU">RYN BATU</option>
									<option value="RYN SINGOSARI">RYN SINGOSARI</option>
									<option value="RYN KEPANJEN">RYN KEPANJEN</option>
									<option value="RYN TUMPANG">RYN TUMPANG</option>
									<option value="RYN GONDANGLEGI">RYN GONDANGLEGI</option>
									<option value="RYN DAMPIT">RYN DAMPIT</option>
									<option value="RYN NGANTANG">RYN NGANTANG</option>
									<option value="RYN SUMBER PUCUNG">RYN SUMBER PUCUNG</option>
									<option value="RYN DINOYO">RYN DINOYO</option>
									<option value="RYN BLIMBING">RYN BLIMBING</option>
									<option value="RYN MALANG KOTA">RYN MALANG KOTA</option>
									<option value="RYN KEBON AGUNG">RYN KEBON AGUNG</option>
								</select>
							...
							<div class="col-md-3">
								<select class="form-control" name="datafilter" id="select_keterangan">
